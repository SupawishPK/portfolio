...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <p className="flex items-center justify-center px-2 py-1 my-3 bg-gray-200 rounded-full dark:bg-dark-700">
        Web Developer
      </p>
      <a
      ...
      <div className="flex items-center justify-center">
        <button
          className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-blue to-blue-400"
          onClick={changeTheme}
        >
          Toggle Theme
        </button>
